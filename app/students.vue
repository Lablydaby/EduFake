...
const students = ref([
	...
	{ id: 3, firstName: "Alice", lastName: "Brown", dob: "1988-03-03", title: "Davao", phone: "134", cell: "094534215", email: "alicebrown@gmail.com" },
	{ id: 4, firstName: "Bob", lastName: "Johnson", dob: "1995-04-04", title: "Cebu", phone: "135", cell: "094534216", email: "bobjohnson@gmail.com" },
	{ id: 5, firstName: "Charlie", lastName: "Lee", dob: "1993-05-05", title: "Manila", phone: "136", cell: "094534217", email: "charlielee@gmail.com" },
	{ id: 6, firstName: "Diana", lastName: "Garcia", dob: "1991-06-06", title: "Davao", phone: "137", cell: "094534218", email: "dianagarcia@gmail.com" },
	{ id: 7, firstName: "Eve", lastName: "Martinez", dob: "1989-07-07", title: "Cebu", phone: "138", cell: "094534219", email: "evemartinez@gmail.com" },
	{ id: 8, firstName: "Frank", lastName: "Wilson", dob: "1994-08-08", title: "Manila", phone: "139", cell: "094534220", email: "frankwilson@gmail.com" },
	{ id: 9, firstName: "Grace", lastName: "Kim", dob: "1996-09-09", title: "Davao", phone: "140", cell: "094534221", email: "gracekim@gmail.com" },
	{ id: 10, firstName: "Henry", lastName: "Lopez", dob: "1997-10-10", title: "Cebu", phone: "141", cell: "094534222", email: "henrylopez@gmail.com" },
	// ...existing code...
...
const filteredStudents = computed(() => {
	...
	if (appliedFilters.value.class.length > 0) {
		data = data.filter((s) => appliedFilters.value.class.includes(`${s.firstName} ${s.lastName}`));
	}
	...
	<Button label="Bulk Update" icon="pi pi-pencil" class="p-button-outlined" />
		...
		<div class="w-full flex items-center gap-2 mb-4 justify-between">
			<div class="flex items-center gap-2">
				...
				<Dropdown v-model="activeStatus" :options="activeOptions" optionLabel="label" placeholder="Active" class="w-32" />
				<Button label="Filter Items" icon="pi pi-filter" class="p-button-outlined" @click="(event) => filterPanelRef.toggle(event)" />
				<OverlayPanel ref="filterPanelRef">
					<div class="p-4 w-96">
						<div class="mb-4">
							<label class="block mb-2 font-semibold">Filter by</label>
							<Dropdown v-model="filterLocation" :options="locationOptions" optionLabel="label" placeholder="Location" class="w-full" />
						</div>
						<div class="mb-4">
							<MultiSelect v-model="filterClass" :options="filterClassOptions" optionLabel="label" placeholder="Class" class="w-full" filter display="chip" />
						</div>
						<div class="mb-4">
							<Dropdown v-model="filterStaff" :options="staffOptions" optionLabel="label" placeholder="Staff" class="w-full" />
						</div>
						<div class="flex justify-between mt-6">
							<Button label="Clear" class="p-button-outlined" @click="filterLocation = null; filterClass = []; filterStaff = null; appliedFilters.location = null; appliedFilters.class = []; appliedFilters.staff = null; filterPanelRef.hide();" />
							<Button label="Apply" class="p-button-primary" @click="appliedFilters.location = filterLocation; appliedFilters.class = filterClass; appliedFilters.staff = filterStaff; filterPanelRef.hide();" />
						</div>
					</div>
				</OverlayPanel>
			</div>
		...
		<div class="overflow-x-auto">
			<DataTable
				...
				@page="(e) => { currentPage = e.page + 1; perPage = e.rows; }"
				dataKey="id"
